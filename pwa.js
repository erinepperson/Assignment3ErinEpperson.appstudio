...
const cacheName = 'A3ErinEpperson-2021-03-14 13:03:20.317500'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A3ErinEpperson'.length) === 'A3ErinEpperson') {
